...
import com.tourhub.security.filters.GlobalRateLimitFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector)
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/storefront/pages").permitAll()
                        .requestMatchers(HttpMethod.GET, "/storefront/pages/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/storefront/homepage").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/storefront").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/storefront/pages/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/storefront/homepage").hasRole("ADMIN")
